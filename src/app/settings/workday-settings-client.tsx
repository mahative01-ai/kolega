...
import { upsertWeeklyWorkRulesAction, updateStudioWeekStartAction } from "./actions";
  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-0.5">
            <span className="text-base font-semibold text-zinc-900">Hari Kerja</span>
          </div>
          <p className="text-sm text-zinc-500">
            Klik untuk cycling: <span className="font-medium text-zinc-700">Off</span> →{" "}
            <span className="font-medium text-zinc-900">Wajib</span> →{" "}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="mb-4">
            <p className="text-base font-semibold text-zinc-900">Minggu Dimulai</p>
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="mb-4">
            <p className="text-base font-semibold text-zinc-900">Jumlah Hari Kerja Bulanan</p>
            <p className="text-sm text-zinc-500">Cara hitung total hari kerja per bulan</p>
          </div>
          <div
            className="rounded-lg border-2 border-emerald-500 bg-emerald-50 p-3 cursor-default"
          >
            <div className="flex items-center justify-between mb-1">
              <span className="text-sm font-semibold text-emerald-900">Berbasis Kalender</span>
              <Badge className="text-[10px] bg-emerald-500 text-white border-0">Aktif</Badge>
            </div>
            <p className="text-xs text-emerald-700">Hitung hari wajib di tiap bulan secara dinamis</p>
