  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl overflow-hidden p-0 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 font-sans">
        ...
        <div className="mx-6 mb-6 overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/10 p-5 flex items-center justify-center">
          <div className="w-full max-w-[560px] aspect-[720/460] overflow-hidden rounded-lg shadow-sm border border-zinc-200/50 dark:border-zinc-800 bg-white dark:bg-zinc-950">
            <iframe
        ...
        <DialogFooter className="flex flex-col gap-2 border-t border-zinc-100 bg-zinc-50 px-6 py-4 dark:border-zinc-800 dark:bg-zinc-900/30 sm:flex-row sm:flex-wrap sm:justify-end">
          <Button
            ...
            size="sm"
            onClick={handlePrint}
            className="h-9 text-xs cursor-pointer border-zinc-200 dark:border-zinc-800 bg-white hover:bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-semibold"
          >
            <Printer className="size-3.5 mr-1.5 text-zinc-500" />
            PDF / Print
          </Button>
          <a
          ...
          <a
            href="/member/presensi/qr-card?format=svg"
            download="my-qr-card.svg"
            className="inline-flex h-9 items-center justify-center rounded-md border border-zinc-200 bg-white px-3 text-xs font-semibold text-zinc-900 shadow-sm hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-50 dark:hover:bg-zinc-900 cursor-pointer"
          >
            <Download className="size-3.5 mr-1.5 text-zinc-500" />
            Download SVG
          </a>
          <Button variant="ghost" size="sm" onClick={() => setOpen(false)} className="h-9 text-xs cursor-pointer font-medium text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50">
            Close
          </Button>
        </DialogFooter>
      </DialogContent>
